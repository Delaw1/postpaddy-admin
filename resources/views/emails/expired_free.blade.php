        ...
        <div style="max-width: 600px; margin: auto; padding-bottom: 4rem; background-color: #ffffff; font-family: 'Red Hat Display', sans-serif; font-weight: 300;">
            ...
            <div style="width: 100%;">
                ...
                <div style="width: 80%; margin: auto;">
                    <h1 style="font-weight: 600; color: #0D2B57">Your Free Trial Has Expired</h1>
                    <p>Hi <span style="font-weight: 500;">{{NAME}}</span>,</p>
                    <p>Your free trial to PostSlate has expired but don’t fret, 
                        your progress and activities have been saved. 
                    </p>
                    <p>However, to continue enjoying full access to PostPaddy’s
                        premium features, you have to upgrade to any of our 
                        value-priced plans starting at N2,999 per month.
                    </p>
                    <br>
                    <div style="width: 100%;">
