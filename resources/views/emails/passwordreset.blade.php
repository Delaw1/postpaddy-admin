        ...
        <div style="max-width: 600px; margin: auto; padding-bottom: 4rem; background-color: #ffffff; font-family: 'Red Hat Display', sans-serif; font-weight: 300;">
            ...
            <div style="width: 100%;">
                ...
                <div style="width: 80%; margin: auto;">
                    <h1 style="font-weight: 600; color: #0D2B57">Reset your password</h1>
                    <p>Hi <span style="font-weight: 500;">{{NAME}}</span>,</p>
                    <p>We received a request to change your password. 
                        We want to ensure that you carried out this action.
                    </p>
                    <p>If this is you, click the button below to set a new password for your account.</p>
                    <br>
                    <div style="width: 100%;">
                        <a href="https://postpaddy.com/password-reset/{{TOKEN}}" style="display: block; width: 100%; margin: auto;">
