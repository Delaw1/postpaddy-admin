    ...
    <div style="width: 100%; height: 100%; display: flex; justify-content: center; background-color: #f5f5f5; padding: 4rem 0;">
        <div style="max-width: 600px; margin: auto; padding-bottom: 4rem; background-color: #ffffff; font-family: 'Poppins', sans-serif; font-weight: 300;">
            ...
            <div style="width: 100%;">
                ...
                <div style="width: fit-content; margin: 2rem auto;">
                    <img style="width: 10rem; height: auto;" src="https://postpaddy.com/api/images/reminder.png" alt="postpaddy" />
                </div>
                <div style="width: 90%; margin: auto;">
                    <p style="text-align: center; font-weight: 600; font-size: 150%;">Reminder!</p>
                    <p style="text-align: center; width: 80%; margin: auto;">Hi {{NAME}} , your subscription to your monthly plan will expire soon ({{DAYS}} days left). {{PLAN}} plan at N{{PRICE}}/month starting {{DATE}}. To renew, please review your subscription here.</p>
                    <br>
                    <div style="width: 100%;">
